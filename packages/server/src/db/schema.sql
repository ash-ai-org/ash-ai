...
CREATE INDEX idx_messages_session ON messages(tenant_id, session_id, sequence);
...
CREATE INDEX idx_session_events_session ON session_events(tenant_id, session_id, sequence);

CREATE INDEX idx_session_events_type ON session_events(tenant_id, session_id, type);
