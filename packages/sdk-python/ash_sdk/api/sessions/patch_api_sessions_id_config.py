...
) -> Optional[Union[ApiError, PatchApiSessionsIdConfigResponse200]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiError, PatchApiSessionsIdConfigResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ApiError, PatchApiSessionsIdConfigResponse200]
    """
